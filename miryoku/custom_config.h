...
#undef MIRYOKU_ALTERNATIVES_BASE_QWERTY
#undef MIRYOKU_ALTERNATIVES_TAP_QWERTY
#undef MIRYOKU_ALTERNATIVES_NAV_VI
#undef MIRYOKU_ALTERNATIVES_MOUSE_VI
#undef MIRYOKU_ALTERNATIVES_MOUSE
#undef MIRYOKU_ALTERNATIVES_MEDIA_VI
#undef MIRYOKU_ALTERNATIVES_MEDIA
#undef MIRYOKU_ALTERNATIVES_NUM
#undef MIRYOKU_ALTERNATIVES_SYM
#undef MIRYOKU_ALTERNATIVES_FUN
#undef MIRYOKU_ALTERNATIVES_BUTTON
...
U_NU,              U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RGB_TOG,         U_RGB_EFF,         U_RGB_HUI,         U_RGB_SAI,         U_RGB_BRI,         U_NU,     \
